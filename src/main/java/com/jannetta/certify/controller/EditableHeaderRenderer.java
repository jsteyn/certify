...
/*
 * @see https://stackoverflow.com/questions/7137786
 */
public class EditableHeaderRenderer implements TableCellRenderer {
	private static Logger logger = LoggerFactory.getLogger(EditableHeaderRenderer.class);
    ...
    static public class MouseEventReposter extends MouseAdapter {
        ...
        private boolean repostEvent(MouseEvent e) {
            ...
            logger.trace("mouse clicked on header");
            return true;
        }
